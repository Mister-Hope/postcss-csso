...
function cssoToPostcss(node, postcss, used) {
  ...
  switch (node.type) {
    ...
    case "Atrule":
      ...
      postcssNode.nodes = node.block
        ? listToPostcss(node.block.children, postcss, used)
        : undefined;
    ...
    case "Declaration":
      ...
      postcssNode.value = generate(node.value);
...
export default (node, postcss) => cssoToPostcss(node, postcss, new WeakSet());
